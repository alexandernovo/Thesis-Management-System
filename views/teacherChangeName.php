            ...
            <div class="card mb-4 pb-5 px-4">
                ...
                <div class="card-body">
                    <div class="row mx-auto">
                        ...
                        <form method="post" action="../actions/manageProfileteacher.php">
                            <div class="form-group mt-2">
                                <label>Firstname</label>
                                <input class="form-control" name="firstname" value="<?php echo $_SESSION['teacher_Fname'] ?>" placeholder="Enter your new firstname">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input class="form-control" name="lastname" value="<?php echo $_SESSION['teacher_Lname'] ?>" placeholder="Enter your new lastname">
