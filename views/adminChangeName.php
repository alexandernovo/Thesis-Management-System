                    ...
                    <div class="row mx-auto">
                        ...
                        <form method="post" action="../actions/manageProfileAdmin.php">
                            <div class="form-group mt-2">
                                ...
                                <input class="form-control" name="firstname" value="<?php echo $_SESSION['Admin_Fname'] ?>" placeholder="Enter your new firstname">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input class="form-control" name="lastname" value="<?php echo $_SESSION['Admin_Lname'] ?>" placeholder="Enter your new lastname">
